# $${\color{#4f5743}Charity \space \color{#4f5743}Navigator \space \color{#4f5743}Analysis}$$	 
### $${\color{#4f5743}Analysis \space \color{#4f5743}Overview}$$
...
### $${\color{#4f5743}Data \space \color{#4f5743}Source}$$
 https://www.kaggle.com/datasets/katyjqian/charity-navigator-scores-expenses-dataset/data 

### $${\color{#4f5743}Ownership \space \color{#4f5743} Note \space \color{#4f5743}} $$
I do not claim any right to the data source, I am merely using it to perform statistical analysis to answer key questions
